...
- (void) forget {
	...
	self.oauth_token = @"";
	self.oauth_token_secret = @"";
    [[NSUserDefaults standardUserDefaults] removeObjectForKey:[NSString stringWithFormat:@"%@oauth_token", self.save_prefix]];
    [[NSUserDefaults standardUserDefaults] removeObjectForKey:[NSString stringWithFormat:@"%@oauth_token_secret", self.save_prefix]];

    [[NSUserDefaults standardUserDefaults] removeObjectForKey:[NSString stringWithFormat:@"%@oauth_token_authorized", self.save_prefix]];
